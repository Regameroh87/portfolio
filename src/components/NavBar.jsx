    ...
    <div className="flex flex-row bg-black text-white h-1/5 w-screen">
      <nav className="flex flex-row items-center justify-between h-full w-full mx-auto">
        <div className="flex items-center justify-center flex-1 gap-x-3">
          <a className="p-4 mt-3 transition duration-500 ease-in-out hover:text-gray-600">Home</a>
          <a className="p-4 mt-3 transition duration-500 ease-in-out hover:text-gray-600">About</a>
          <a className="p-4 mt-3 transition duration-500 ease-in-out hover:text-gray-600">Skills</a>
          <a className="p-4 mt-3 transition duration-500 ease-in-out hover:text-gray-600">Contact</a>
        </div>
